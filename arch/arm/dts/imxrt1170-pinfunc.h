...
#define MXRT1170_PAD_ODE_SNVS	(1 << 6)
#define MXRT1170_PAD_ODE_LPSR	(1 << 5)
#define MXRT1170_PAD_ODE	(1 << 4)
#define MXRT1170_PAD_PUS	(1 << 3)
#define MXRT1170_PAD_PUE	(1 << 2)
#define MXRT1170_PAD_DSE	(1 << 1)
#define MXRT1170_PAD_SRE	(1 << 0)
